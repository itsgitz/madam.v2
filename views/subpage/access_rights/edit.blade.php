    ...
    <div class="container-fluid py-5">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <h3 class="py-4">Edit Access Rights for <strong>{{$access_rights['name']}}</strong></h3>
                <form method="POST">
                    <div class="form-group">
                        <label for="name"><b>Name</b></label>
                        <input id="name" class="form-control" type="text" name="name" placeholder="Customer or person name ..." value="{!! $access_rights['name'] !!}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="identityNumber" class="form-control" type="text" name="identity_number" value="{!! $access_rights['identity_number'] !!}" placeholder="Identity number ..." required>
                    </div>
                    <div class="form-group">
                        <label for="email"><b>E-mail Address</b></label>
                        <input id="email" class="form-control" type="email" name="email" value="{!! $access_rights['email'] !!}" placeholder="E-mail address ..." required>
                    </div>
                    <div class="form-group">
                        <label for="status"><b>Status</b></label>
                        <select id="status" class="custom-select" name="status" data-status="{!! $access_rights['status'] !!}" required>
